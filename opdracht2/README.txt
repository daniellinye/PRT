...
Wel is het belangrijk om de export LD_LIBRARY_PATH=. uit te voeren i.v.m. shared libraries. Deze wordt niet geexport in de makefile omdat het netter is in de console.
...
Hiermee wordt de cel geleegd en opent er bovenop de geselecteerde cel een window ten grootte van 2 cellen (de maximale inhoudsgrootte van 1 cel) Hier kunt u de cel van waarde doen veranderen. Druk nogmaals op enter om het window te verlaten en de celwaarde aan te passen naar de ingevoerde waarde.
U kunt ook de cel verwijderen met backspace.

Het programma wordt gecompileerd met g++
